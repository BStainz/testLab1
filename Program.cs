...
Console.WriteLine("Hello, Brendan Hannon!");
Console.WriteLine("Version: {0}", Environment.Version.ToString());
string text = System.IO.File.ReadAllText("text.txt");
Console.WriteLine(text);

Console.WriteLine("Hello, Brendan!");
Console.WriteLine("Version {0}", Environment.Version.ToString());
...
names[3] = "Tom";
names[4] = "Brendan";
string[] names2 = new[] { "Kate", "Jack", "Rebecca", "Tom", "Brendan" };
...
{
  { "Alpha", "Beta", "Gamma", "Delta", "Epsilon" }, //added "Epsilon"
  { "Anne", "Ben", "Charlie", "Doug", "Eddie" },//added "Eddie"
  { "Aardvark", "Bear", "Cat", "Dog","Elk"  } //added "Elk"
};
...
string[][] jagged = new[] // array of string arrays
{
  ...
  new[] { "Anne", "Ben", "Charlie", "Doug","Elvis" }, // added "elvis"
  new[] { "Aardvark", "Bear", },
  new[] { "Albany", "Boston", "Compton"} // added another row, and added 3 string values
};
...
int[] evenNumbers = new int[] {2, 4, 6, 8, 10}; //added new int[] evenNumbers
...
WriteLine($"{nameof(evenNumbers)}: {CheckSwitch(evenNumbers)}"); 
//added lineabove to check evenNumbers through the switch statements
